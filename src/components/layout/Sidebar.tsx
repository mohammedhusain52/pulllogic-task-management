  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-[#090D16] border-r border-white/10 shrink-0 h-screen sticky top-0">
      ...
      <div className="p-4 border-b border-white/10">
        <Link href="/" className="block space-y-1 group">
          <div className="flex items-center gap-2.5">
            <img
              src="/pull-logic-mark.svg"
              alt="Pull Logic"
              className="h-7 w-7 object-contain group-hover:scale-105 transition"
            />
            <span className="text-base font-extrabold text-white tracking-tight group-hover:text-indigo-300 transition">
              Pull Logic
            </span>
          </div>
          <p className="text-xs font-medium text-slate-400 pl-0.5">
            Task Management
          </p>
        </Link>
      </div>
